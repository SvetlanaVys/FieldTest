...
public class OptionAction extends play.mvc.Action.Simple {
    private final Logger.ALogger logger = play.Logger.of("application.OptionAction");
    ...
    @Singleton
    @Inject
    public OptionAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(OptionAction.class, "responsesTimer"));
    }
